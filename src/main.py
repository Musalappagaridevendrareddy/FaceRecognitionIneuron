...
def check_name(name: str):
	...
	return {"name": name, "name_Predicted": name_check}


if __name__ == '__main__':
	st.title("Face Recognition App")
	st.subheader("This is a simple app to recognize faces")
	st.sidebar.title("Menu")
	# enter the name of the person to be registered
	name = st.sidebar.text_input("Enter the name of the person to be registered")
	if st.sidebar.button("Register"):
		collectUserImageForRegistration(name)
		st.success("Images collected for " + name)
	elif st.sidebar.button("Check"):
		st.write(check_name(name))